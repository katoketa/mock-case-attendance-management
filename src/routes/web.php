...
Route::middleware('auth:web')->group(function () {
    ...
    Route::post('/attendance/start_break_time', [RegisterAttendanceController::class, 'startBreakTime'])->name('attendance.start_break_time');
    Route::post('/attendance/end_break_time', [RegisterAttendanceController::class, 'endBreakTime'])->name('attendance.end_break_time');
